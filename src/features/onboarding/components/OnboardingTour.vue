 ...
 * the progress track — is the kit's (rei-kit 0.14.0). Kakei had the same 296
 * lines. What is left here is the part that is Hibi's: which slides there are,
