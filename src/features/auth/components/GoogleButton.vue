...
<template>
  <button
    type="button"
    class="border-hair bg-surface text-ink rounded-card hover:bg-mist flex h-11 w-full items-center justify-center gap-2 border text-sm font-medium transition-colors active:scale-95"
    @click="emit('click')"
  >
