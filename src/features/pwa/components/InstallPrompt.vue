...
const SNOOZE_KEY = 'hibi-install-nudge'
const SNOOZE_DAYS = 7
...
<template>
  <Transition name="install">
    <section v-if="visible" class="border-leaf/25 bg-leaf/5 rounded-card flex gap-3 border p-3.5">
      <span
        class="bg-leaf/15 text-leaf flex size-10 shrink-0 items-center justify-center rounded-xl"
        aria-hidden="true"
      >
