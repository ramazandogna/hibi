...
<template>
  <component
    ...
    :class="[
      interactive ? 'hover:bg-mist/60 transition-colors active:scale-[0.99]' : '',
  ...
  >
    <div class="flex items-center gap-3">
      <span
        v-if="icon"
        class="bg-mist text-ink-soft flex size-9 shrink-0 items-center justify-center rounded-xl"
        aria-hidden="true"
      >
