 ...
 * before this, none of them reported at all — a habit was archived, a note was
 * saved, and the only evidence was that nothing had visibly broken.
 *
 * Deliberately generic. A message naming the thing that was saved reads better
 * once and worse every time after, and marking habits is something somebody
